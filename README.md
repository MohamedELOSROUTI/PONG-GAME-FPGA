...
- 2 processes are dedicated to manage the press buttons of players 1 and 2. This will allow to update the position of the leds ranging from 25 to 32. Using push often generates many false triggers when pressed. We'll see later how can deal with switch bounce.
- 1 process to generate a low frequency clock of 1 Hz from the 50 MHz clock.
- 1 process to generate randomness using cnt_rnd. It allows to determinate the trajectory of the ball.
...
<p align="center">
  <img src="https://i.imgur.com/AwwOMj3.jpg" width="500" height="500"/>
</p>
...
This problem may affect the way we move the yellow leds under and above the matrix leds. One single push to the right/left press buttons may result in lighting up the extremities leds skiping intermediate leds. 


How to deal with bounce switch ? There are two solutions : 

- Hardware approach : use a capacitor in series to make a RC filter. This allows to remove the osccitilliations but the high state is reached after a constant time proportial to R*C.
...
<p align="center">
  <img src="https://i.imgur.com/Q33EDYZ.png"  />
</p>
